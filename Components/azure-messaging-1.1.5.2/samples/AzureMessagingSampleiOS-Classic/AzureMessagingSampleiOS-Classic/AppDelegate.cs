...
namespace AzureMessagingSampleiOS
{
	...
	{
		const string HUB_NAME = "boardmsg";
		const string HUB_LISTEN_SECRET = ";SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=xV/1o+kFKiH9sfH4jBht/qalIKuOiMIn2ZczyCT1/mk=";
