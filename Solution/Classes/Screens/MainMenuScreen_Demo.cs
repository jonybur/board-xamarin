	...
	public partial class MainMenuScreen
	{
		private static List<Board.Schema.Board> GenerateBoardList()
		{
			...
			using (UIImage img = UIImage.FromFile("./logos/americansocial.jpeg")){
				Board.Schema.Board board = new Board.Schema.Board ("American Social", img, UIColor.FromRGB (67, 15, 0), UIColor.FromRGB (221, 169, 91), "Brickell", Profile.CurrentProfile.UserID);
				boardList.Add(board);
			}
			...
			using (UIImage img = UIImage.FromFile("./logos/doloreslolita.jpg")){
				...
				Board.Schema.Board demoboard = new Board.Schema.Board ("Dolores Lolita", img, UIColor.FromRGB (185, 143, 6), UIColor.FromRGB (2, 0, 6), "Brickell", string.Empty);	
			...
			using (UIImage img = UIImage.FromFile ("./logos/tavernopa.png")) {
				Board.Schema.Board demoboard = new Board.Schema.Board ("Taverna Opa", img, UIColor.FromRGB (140, 52, 50), UIColor.FromRGB (77, 185, 155), "Brickell", string.Empty);
