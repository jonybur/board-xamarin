...
namespace Board.Screens.Controls
{
	public class UICarouselContentDisplay : UIContentDisplay {
		...
		public UICarouselContentDisplay(){
			...
			for (int i = 0; i < 5; i++) {
				var carousel = new UICarouselController ("CAROUSEL " + i);
				carousel.View.Center = new CGPoint (AppDelegate.ScreenWidth / 2,
					UIMagazineBannerPage.Height + UIMenuBanner.MenuHeight + SeparationBetweenCarousels + carousel.View.Frame.Height / 2 + (carousel.View.Frame.Height + SeparationBetweenCarousels) * i);
